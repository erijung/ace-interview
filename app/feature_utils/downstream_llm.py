...
def generate_feedback(emotion_analysis, prosodic_analysis, smile_counts, pose_analysis, recorded_interview):
    ...
    user_prompt = f"""Look through each frame in the video and analyze the interview performance data and generate comprehensive, personalized, conversational evaluation of the candidate’s performance. Only base your answers strictly on what information is available in the video and the information provided.  Do not make up any information that is not part of the video or information provided. Your analysis should be a professional coaching document that provides deep insights into the candidate's performance and areas for growth.
    ...
    - pose_analysis data: contains the number of sampled frames, the number of frames where the candidate was doing a full body slouch, the number of frames where the candidate was tilting their head, and the number of frames where the candidate’s hands were touching their face.
    - recorded_interview file: contains the video of the interview
